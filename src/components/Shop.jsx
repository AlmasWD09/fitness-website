            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 md:grid-cols-3 gap-5">
                <div className="lg:w-[312px] border p-5 ">
                    ...
                    <div className="flex lg:py-16 justify-center">
                        <img src="https://i.ibb.co.com/RHRPfHS/Whats-App-Image-2024-12-17-at-10-08-22-b2f3597f.jpg" alt="" />
                ...
                <div className="lg:w-[312px] border p-5 ">
                    ...
                    <div className="flex lg:py-16 justify-center">
                        <img src="https://i.ibb.co.com/WKKQSLW/Whats-App-Image-2024-12-17-at-10-08-23-5ecec3e4.jpg" alt="" />
                ...
                <div className="lg:w-[312px] border p-5 ">
                    ...
                    <div className="flex lg:py-16 justify-center">
                        <img src="https://i.ibb.co.com/Wy2ZL7q/Whats-App-Image-2024-12-17-at-10-08-23-a1bc66c1.jpg" alt="" />
                ...
                <div className="lg:w-[312px] border p-5 ">
                    ...
                    <div className="flex lg:py-16 justify-center">
                        <img src="https://i.ibb.co.com/cQ0fc94/Whats-App-Image-2024-12-17-at-10-08-24-bfe4283f.jpg" alt="" />
                    </div>
                    <div className="text-[#555555] mb-3">
                        <p>The Ball</p>
                        <h3 className="text-2xl mt-3 font-medium">$34.00 CND</h3>

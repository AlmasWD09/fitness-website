    ...
    <section className="px-4 lg:h-[525px] mb-10 lg:px-0 lg:max-w-[1320px] mx-auto">
            <div className="lg:flex gap-20">
                <div className="lg:w-[541px]">
                    ...
                    <img src="https://i.ibb.co.com/y6bFXcV/Whats-App-Image-2024-12-17-at-10-08-24-2dc11c4f.jpg" alt="" />
                    </div>
                    <img src=" https://i.ibb.co.com/jbJhJdK/Whats-App-Image-2024-12-17-at-10-08-22-41a4062a.jpg" className="absolute md:-bottom-56 -bottom-60  md:right-10 lg:-right-5" alt="" />
                    </div>
